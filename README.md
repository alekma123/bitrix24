>1. Компонент (/local/components/custom/crm.deal.create/)
...
>2.  js-расширение (/local/js/crm-deal) 
...
>4. Обработчик (/local/php_interface/EventHandlers/DealEventHandler.php)
 
c логированием в /local/php_interface_php/logs/handler.log
